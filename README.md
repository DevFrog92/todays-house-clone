...
- login을 했을 경우
  ...
  <div class="button-group">
    ...
    <a href="/" class="gnb-icon-button sm-hidden" aria-label="스크랩 페이지로 이동">
      <i class="ic-bookmark"></i>
    </a>

    <a href="/" class="gnb-icon-button sm-hidden" aria-label="내소식 페이지로 이동">
      <i class="ic-bell"></i>
    </a>
    ...
    <button class="gnb-avatar-button sm-hidden" type="button" aria-label="마이메뉴 열기 버튼">
      <div class="avatar-32">
        <img src="./assets/images/img-user-01.jpg" alt="profile image">
      </div>
    </button>
  </div>
  ```
